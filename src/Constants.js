...
export const DEFAULT_STATE = {
	...
	adaptiveSamplingVarianceThreshold: 0.1, // Compared against (frame+1)²-scaled temporal variance (~5×σ²)
	...
	upscalerQuality: 'fast', // 'fast', 'balanced', 'quality'
	upscalerHdr: true,
	...
	autoExposureAdaptSpeedBright: 3.0, // Speed for bright adaptation (~0.3s)
	autoExposureAdaptSpeedDark: 0.5, // Speed for dark adaptation (~2s)

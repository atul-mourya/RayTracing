...
describe( 'RenderSettings', () => {
	...
	describe( 'set', () => {
		...
		it( 'routes uniform setting to pathTracingStage', () => {

			const mockStage = { setUniform: vi.fn() };
			settings.bind( { pathTracingStage: mockStage, resetCallback: vi.fn() } );
		...
		it( 'calls resetCallback when route has reset: true', () => {
			...
			const resetCb = vi.fn();
			const mockStage = { setUniform: vi.fn() };
			settings.bind( { pathTracingStage: mockStage, resetCallback: resetCb } );
